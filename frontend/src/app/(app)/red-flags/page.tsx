...
export default function RedFlagsPage() {
  ...
  // Phase 9: backend serves excluded list at a separate endpoint (TAD g02 §1 registry).
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {(runsRes.loading || resultsRes.loading || excludedRes.loading) && (
      ...
      {resultsRes.data && (
        <>
          <section className="flex flex-col gap-3">
            ...
            <RedFlagsExcludedTable excluded={excludedRes.data?.items ?? []} />
          </section>
