...
AI-assisted screener cho cổ phiếu bất động sản niêm yết trên sàn chứng khoán Việt Nam (HOSE, HNX, UPCOM). Single-user MVP — frontend Next.js + backend FastAPI + SQLite.
