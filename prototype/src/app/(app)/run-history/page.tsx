        ...
        <>
          ...
          {backtest.activeId !== null && (
            <section className="flex flex-col gap-3">
              ...
              {backtest.isRunning && backtest.polling.data && (
                <div className="card p-4 flex flex-col gap-2">
                  <div className="flex items-center justify-between gap-3">
                    <span className="text-xs">{backtest.polling.data.current_step}</span>
                    <span className="text-2xs tabular-nums" style={{ color: 'var(--color-theme-text-secondary)' }}>
                      {backtest.polling.data.progress_percent}%
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: `${backtest.polling.data.progress_percent}%`,
                        backgroundColor: 'var(--ssi-up)',
                      }}
                    />
                  </div>
                </div>
