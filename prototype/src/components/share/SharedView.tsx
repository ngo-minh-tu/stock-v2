      ...
      <div className="relative" style={{ zIndex: 1 }}>
        ...
        >
          <div>
            ...
            <p className="text-2xs" style={{ color: 'var(--color-theme-text-secondary)' }}>
              {t('sharedBy', { name: shared_by, date: formatDate(link.created_at) })}
            </p>
          </div>
          <div
            ...
            title={`Hết hạn: ${formatDate(link.expires_at)}`}
          >
            {t('expiresIn', { remaining: relativeExpiry(link.expires_at) })}
          </div>
        </header>
        ...
        <main className="px-6 py-6 flex flex-col gap-6 max-w-7xl mx-auto">
          <section className="flex flex-col gap-3">
            ...
            <DashboardGrid data={run.dashboard} />
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <TopMuaTable results={run.results} runId={run.run_id} readOnly />
          </section>
